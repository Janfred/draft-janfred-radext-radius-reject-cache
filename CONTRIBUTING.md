...
Discussion of this work occurs on the [RADIUS EXTensions
Working Group mailing list](mailto:radext@ietf.org)
([archive](https://mailarchive.ietf.org/arch/browse/radext/),
[subscribe](https://www.ietf.org/mailman/listinfo/radext)).
...
[Working Group documents](https://datatracker.ietf.org/wg/radext/documents/).
